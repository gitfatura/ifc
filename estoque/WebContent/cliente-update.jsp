  ...
  <div class="div-interna-update-cliente">
	 ...
	 <table>
		...
		<tr>
			<td>Cpf</td>
			<td>
			<input type="text" class="input-update-cliente" name="cpf" autocomplete="on" value="${cliente.cpf}" required="required" style="width:134px"> 
			RG  <input type="text" class="input-update-cliente" name="rg" value="${cliente.rg}" style="width:140px">		
			</td>		
		</tr>
		...
		<tr>
			<td>Telefone</td>
			<td>
			<input type="text" class="input-update-cliente" name="telefone" autocomplete="on" value="${cliente.telefone}" required="required" style="width:130px">
