...
<body>
 <div class="div-login" >
	...
	<form action="autentica" accept-charset="UTF-8" method="post">
	  ...
	  <label class="lbl-login">Usuario</label><br/>
	  <input type="text" class="input-login" name="usuario" style="width:150px"><br/>
	  
	  <label class="lbl-login">Senha</label><br/>
	  <input type="password" class="input-login" name="senha" style="width:150px"><br/><br/>
